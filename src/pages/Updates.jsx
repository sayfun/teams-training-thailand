...
const POSTS = [
  { tag:'Upcoming', title:'Discover Strength & Build Confidence', excerpt:'A half-day workshop for students to explore their personal strengths in a team setting. Ages 8–16. Limited spots.', meta:'26 April 2026 · Sanctuary Studio, Sukhumvit 103', img:'https://wp.teamstrainingthailand.com/wp-content/uploads/2026/04/TEAMS-Posts-Square-6-1024x1024.png', slug:'discover-strength-build-confidence' },
  { tag:'Youth Camp', title:'TEAMS Discovery Camp (Ages 8–12)', excerpt:'Two mornings of purposeful activities designed to help kids discover how they lead, communicate and collaborate under pressure.', meta:'March 28–29 · C2 Community, Phayathai', img:'https://wp.teamstrainingthailand.com/wp-content/uploads/2026/02/WhatsApp-Image-2569-02-16-at-17.06.08-1-e1771246947605-1024x607.jpeg', slug:'teams-discovery-camp' },
  { tag:'Past Event', title:'Bridging Borders: Thai & Korean Students in Ayutthaya', excerpt:'How we designed a cross-cultural team building day for Thai and Korean students on a shared trip to Ayutthaya.', meta:'January 2026 · Ayutthaya', img:'https://wp.teamstrainingthailand.com/wp-content/uploads/2026/01/WhatsApp-Image-2569-01-11-at-16.19.41-1024x768.jpeg', slug:'bridging-borders-how-we-united-thai-and-korean-students-on-a-trip-to-ayutthaya' },
  { tag:'Past Event', title:'TEAMS x Thammasat University', excerpt:'Building connections through teamwork — a full-day program for incoming students at Thammasat University, Bangkok.', meta:'August 2025 · Thammasat University', img:'https://wp.teamstrainingthailand.com/wp-content/uploads/2025/08/IMG_5193-1024x768.jpg', slug:'teams-x-thammasat-university-building-connections-through-teamwork' },
  { tag:'Program', title:'The Kind Leaders Project', excerpt:'A multi-session leadership development program focused on kindness as a core leadership competency for young people.', meta:'October 2025', img:'https://wp.teamstrainingthailand.com/wp-content/uploads/2025/10/Poster-2-724x1024.png', slug:'the-kind-leaders-project' },
]
    ...
    <main style={{paddingTop:'70px'}}>
      <section className="section" style={{background:'var(--white)'}}>
        ...
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(320px,1fr))', gap:'1.5rem'}}>
          {POSTS.map((p,i) => (
            <Link to={`/blog/${p.slug}`} className="ev-card fu" key={i} ref={r} style={{transitionDelay:`${i*0.07}s`, textDecoration:'none', display:'block', borderRadius:'16px', overflow:'hidden', border:'1px solid var(--border)', transition:'transform 0.25s, box-shadow 0.25s', background:'var(--white)'}}>
